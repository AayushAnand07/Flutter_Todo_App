...
class _AddTodoScreenState extends State<AddTodoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(
          leading: IconButton(icon:Icon(Icons.arrow_back_ios_new),color: Colors.white,onPressed:() =>  Navigator.of(context).pop(),),
         title: Text(!_isEditing ? 'Add Todo' : 'Update Todo',style: TextStyle(color: Colors.white),),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                //Text(!_isEditing ? 'Add Todo' : 'Update Todo',style: TextStyle(fontSize: 22,color: Colors.white),),
